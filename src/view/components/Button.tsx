...
type Variants = 'primary' | 'dashed' | 'link' | 'text' | 'default';
...
const buttonVariants = (variant: Variants = 'primary', theme: DefaultTheme) => {
  const variantStyles = {
    primary: css`
...
const buttonSizes = (size: Sizes = 'large', theme: DefaultTheme) => {
  const sizeStyles = {
    small: css`
